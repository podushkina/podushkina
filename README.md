...
- [`math-statistics`](https://github.com/podushkina/math-statistics)  
  📈 Курсовая по ТВиМС: МНК-оценка параметров полиномиальной регрессии, доверительные интервалы для коэффициентов/дисперсии/сигнала, графики и проверка нормальности остатков (χ² Пирсона). В репозитории есть отчёт в PDF.

- [`mnist-cnn`](https://github.com/podushkina/mnist-cnn)  
  🧠 CNN для распознавания рукописных цифр MNIST: обучение модели, оценка качества и пример предсказания (inference) на новых изображениях.
